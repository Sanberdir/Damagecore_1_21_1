...
/** Значок "источник — игрок" (не зелье: стрелы, удары и т.п.), полоска и тултип. */
public final class PlayerEffectIconRenderer {

    private static final int ICON_U = 64 + 3;   // = 67
    private static final int ICON_V = 0  + 4;   // = 4
    private static final int ICON_REGION = 10;

    private PlayerEffectIconRenderer() {}
    ...
    public static void renderTooltip(GuiGraphics gui, Minecraft mc,
        ...
        lines.add(Component.translatable("damagecore.potion_tab.source_player")
